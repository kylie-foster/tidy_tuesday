...
ggplot() +
  ...
  geom_point(data = student_ratio_long, aes(x = value, y = country, colour = year), size = 3.5) + 
  ...
  labs(title = "Change in student to teacher ratios from 2012 to 2017",
       ...
       caption = "While most ratios did not change substantially between 2012 and 2017, some ratios increased.
       \nSource: https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-05-07") +
